...
$renderRow = static function (array $item, string $index) use ($widgets, $renderFields): void {
    ...
    ?>
    <div class="builder-row" data-widget-item data-widget-label="<?= esc_attr($label) ?>">
        ...
        <div class="builder-summary">
            ...
            <div class="builder-actions">
                <button class="btn btn-light btn-icon builder-action" type="button" data-widget-item-up aria-label="<?= esc_attr(t('widgets.move_up')) ?>" title="<?= esc_attr(t('widgets.move_up')) ?>">
                    <?= icon('next', 'icon builder-icon-up') ?>
                </button>
                <button class="btn btn-light btn-icon builder-action" type="button" data-widget-item-down aria-label="<?= esc_attr(t('widgets.move_down')) ?>" title="<?= esc_attr(t('widgets.move_down')) ?>">
