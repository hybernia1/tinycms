...
final class View
{
    ...
    private function renderFiles(string $templateFile, string $layoutFile, string $layout, array $data = []): void
    {
        ...
        $contentMedia = static fn(string $path, string $size = ThumbnailVariants::SMALL_NAME): string => ThumbnailVariants::contentMediaPath($path, $size);
        ...
        $data['t'] = $t;
        $data['contentMedia'] = $contentMedia;
