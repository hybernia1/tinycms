...
register_routes($router, $redirect, [
    ...
    ['method' => 'GET', 'path' => 'sitemap-content{chunk}.xml', 'controller' => $front, 'action' => 'sitemapContent', 'raw_params' => true],
    ['method' => 'GET', 'path' => 'sitemap-terms{chunk}.xml', 'controller' => $front, 'action' => 'sitemapTerms', 'raw_params' => true],
