...
register_routes($router, $redirect, [
    ...
    ['method' => 'GET', 'path' => 'admin/api/v1/heartbeat', 'controller' => $admin, 'action' => 'heartbeatApiV1', 'with_redirect' => false],
    ['method' => 'POST', 'path' => 'admin/api/v1/auth/login', 'controller' => $admin, 'action' => 'loginApiV1', 'with_redirect' => false],
