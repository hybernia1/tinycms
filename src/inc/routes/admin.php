...
register_routes($router, $redirect, [
    ...
    ['method' => 'GET', 'path' => 'admin/api/v1/users', 'controller' => $apiUsers, 'action' => 'listApiV1'],
    ['method' => 'POST', 'path' => 'admin/api/v1/users/add', 'controller' => $apiUsers, 'action' => 'addApiV1'],
    ['method' => 'POST', 'path' => 'admin/api/v1/users/{id}/edit', 'controller' => $apiUsers, 'action' => 'editApiV1', 'params' => ['id' => 'int']],
    ['method' => 'POST', 'path' => 'admin/api/v1/users/{id}/delete', 'controller' => $apiUsers, 'action' => 'deleteApiV1', 'params' => ['id' => 'int']],
    ['method' => 'POST', 'path' => 'admin/api/v1/users/{id}/suspend', 'controller' => $apiUsers, 'action' => 'suspendApiV1', 'params' => ['id' => 'int']],
