...
$frontServices = new FrontServices($contentService, $commentService, $userService, $mediaService, $termService, $settingsService);
$frontAdminBar = new AdminBar($router, $auth);
$frontView = new FrontView(BASE_DIR, $router, $resolvedSettings, $frontAdminBar, $csrf);
