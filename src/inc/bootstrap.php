...
use App\Controller\Api\Users as UsersController;
...
$apiSessions = new SessionsController($authService, $csrf, $rateLimiter);
$apiUsers = new UsersController($authService, $userService, $flash, $csrf);
