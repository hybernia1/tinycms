...
$frontView = new FrontView(BASE_DIR, $router, $resolvedSettings, $frontAdminBar, $menuService, $contentService, $widgetService, $commentService, $auth, $csrf);
$front = new FrontController($frontView, $settingsService, $termService, $userService, $auth, $resolvedSettings);
$frontAvatar = new AvatarController(new AvatarService());
$frontComments = new FrontCommentController($auth, $commentService, $csrf);
