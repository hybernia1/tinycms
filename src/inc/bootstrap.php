...
use App\Controller\Admin\Widgets as WidgetsController;
...
use App\Controller\Api\Widgets as ApiWidgetsController;
...
$frontView = new FrontView(BASE_DIR, $router, $resolvedSettings, $frontAdminBar, $menuService);
...
$adminWidgets = new WidgetsController($adminView, $authService, $widgetsService, $flash, $csrf);
$apiWidgets = new ApiWidgetsController($authService, $widgetsService, $flash, $csrf);
