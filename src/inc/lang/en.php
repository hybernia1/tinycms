...
return [
    ...
    'front' => [
        ...
        'comments_form_title' => 'Add comment',
        'comments_reply_title' => 'Reply',
        'comments_replying_to' => 'Replying to %s',
        'comments_submit' => 'Send comment',
        'comments_login_required' => 'Please %ssign in%s to comment.',
        'comments_no_author' => 'No author',
        'comments_edit' => 'Edit',
        'comments_count' => '%d comments',
        'comments_sort_label' => 'Comment sorting',
        'comments_sort_relevant' => 'Relevant',
        'comments_sort_newest' => 'Newest',
        'comments_sort_oldest' => 'Oldest',
        'comments_load_more' => 'Load more comments',
        'comments_load_more_replies' => 'Load more replies',
        'comments_show_replies' => 'Replies %d',
        'comments_pending' => 'Your comment is waiting for approval.',
        'login' => [
            'title' => 'Login',
