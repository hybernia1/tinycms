...
return [
    ...
    'content' => [
        ...
        'source' => 'Source',
        'import_site_url' => 'WordPress site',
        'import_start_page' => 'Start page',
        'import_batch_pages' => 'Batch',
        'import_wp_submit' => 'Import from WP',
        'import_wp_help' => 'Import runs in batches. Continue with the next page after each run.',
