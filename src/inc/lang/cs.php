...
return [
    ...
    'front' => [
        ...
        'comments_empty' => 'Zatím tu nejsou žádné komentáře.',
        'comments_form_title' => 'Přidat komentář',
        'comments_reply_title' => 'Odpovědět',
        'comments_replying_to' => 'Odpověď na %s',
        'comments_submit' => 'Odeslat komentář',
        'comments_login_required' => 'Pro komentování se prosím %spřihlaste%s.',
        'comments_no_author' => 'Bez autora',
        'comments_edit' => 'Upravit',
        'comments_count' => 'Komentářů: %d',
        'comments_sort_label' => 'Řazení komentářů',
        'comments_sort_relevant' => 'Relevantní',
        'comments_sort_newest' => 'Nejnovější',
        'comments_sort_oldest' => 'Nejstarší',
        'comments_load_more' => 'Načíst další komentáře',
        'comments_load_more_replies' => 'Načíst další odpovědi',
        'comments_show_replies' => 'Odpovědi %d',
        'comments_pending' => 'Váš komentář čeká na schválení.',
        'login' => [
            'title' => 'Login',
