...
$dateTimeService = new DateTimeService($settingsService);
$contentService = new ContentService($dateTimeService);
$pageView = new PageView($view, $settingsService, $contentTypes, $dateTimeService);
