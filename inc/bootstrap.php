...
$frontPageView = new FrontPageView($view, $themeService);
$adminPageView = new AdminPageView($view, $settingsService);
$front = new FrontController($frontPageView, $authService, $csrf, $settingsService, $contentService, $termService, $slugger);
$admin = new AdminController($adminPageView, $authService);
$adminUsers = new AdminUserController($adminPageView, $authService, $userService, $flash, $csrf);
$adminContent = new AdminContentController($adminPageView, $authService, $contentService, $userService, $termService, $flash, $csrf);
$adminContentMediaApi = new AdminContentMediaApiController($authService, $contentService, $mediaService, $uploadService, $flash, $csrf);
$adminMedia = new AdminMediaController($adminPageView, $authService, $mediaService, $uploadService, $flash, $csrf);
$adminSettings = new AdminSettingsController($adminPageView, $authService, $settingsService, $uploadService, $flash, $csrf);
$adminTerms = new AdminTermController($adminPageView, $authService, $termService, $flash, $csrf);
