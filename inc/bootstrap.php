...
$wordpressImportService = new WordpressImportService($contentService, $mediaService, $uploadService, $termService);
...
$adminContent = new AdminContentController($pageView, $authService, $contentService, $mediaService, $uploadService, $userService, $termService, $wordpressImportService, $flash, $csrf);
