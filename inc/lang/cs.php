...
return [
    ...
    'install' => [
        ...
        'requirements_title' => 'Kontrola požadavků',
        'requirements_required_label' => 'Povinné požadavky',
        'requirements_recommended_label' => 'Doporučené požadavky',
        'requirements_blocking' => 'Server nesplňuje povinné požadavky instalace.',
        'requirement.php_version' => 'PHP verze >= 8.1',
        'requirement.ext_pdo' => 'PHP extension: pdo',
        'requirement.ext_pdo_mysql' => 'PHP extension: pdo_mysql',
        'requirement.ext_mbstring' => 'PHP extension: mbstring',
        'requirement.ext_fileinfo' => 'PHP extension: fileinfo',
        'requirement.ext_gd' => 'PHP extension: gd',
        'requirement.ext_iconv' => 'PHP extension: iconv',
        'requirement.ext_session' => 'PHP extension: session',
        'requirement.gd_imagecreatefromjpeg' => 'GD funkce: imagecreatefromjpeg',
        'requirement.gd_imagecreatefrompng' => 'GD funkce: imagecreatefrompng',
        'requirement.gd_imagecreatefromgif' => 'GD funkce: imagecreatefromgif',
        'requirement.gd_imagecreatefromwebp' => 'GD funkce: imagecreatefromwebp',
        'requirement.gd_imagewebp' => 'GD funkce: imagewebp',
        'requirement.fs_config_writable' => 'Zápis do config.php/root adresáře',
        'requirement.fs_uploads_writable' => 'Zápis do uploads/root adresáře',
        'requirement.intl_transliterator' => 'Intl Transliterator (doporučeno)',
        'requirement.ext_curl' => 'PHP extension: curl (doporučeno)',
    ...
    'front' => [
        ...
        'not_found' => [
            ...
            'message' => 'Požadovaný dokument nebyl nalezen.',
            'detail' => 'Zkontrolujte URL adresu nebo požadovaný XML dokument.',
        ],
    ],
    'users' => [
