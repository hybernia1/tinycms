...
return [
    ...
    'content' => [
        ...
        'cat_keyboard_warning' => 'Detekována neobvyklá změna. Možná cat-on-keyboard. Obnovit poslední bezpečnou verzi, nebo pokračovat?',
        'cat_keyboard_restore' => 'Obnovit bezpečnou verzi',
        'cat_keyboard_continue' => 'Pokračovat a uložit',
        ...
        'wp_import_title' => 'WordPress import',
        'wp_import_site_url' => 'WordPress URL',
        'wp_import_site_url_hint' => 'URL zdrojového WordPress webu.',
        'wp_import_mode' => 'Režim importu',
        'wp_import_last_n' => 'Posledních N příspěvků',
        'wp_import_all' => 'Všechny příspěvky',
        'wp_import_count' => 'Počet',
        'wp_import_submit' => 'Importovat',
        'wp_import_invalid_count' => 'Neplatný počet příspěvků.',
        'wp_import_failed' => 'Import z WordPressu se nepodařil.',
        'wp_import_done' => 'Importováno: %d, přeskočeno: %d, selhalo: %d.',
        'statuses' => [
            'draft' => 'Draft',
