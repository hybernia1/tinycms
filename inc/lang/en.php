...
return [
    ...
    'content' => [
        ...
        'wp_import_site_url_hint' => 'URL of source WordPress website.',
        'wp_import_mode' => 'Import mode',
        'wp_import_last_n' => 'Last N posts',
        'wp_import_all' => 'All posts',
        'wp_import_count' => 'Count',
        'wp_import_submit' => 'Import',
        'wp_import_invalid_count' => 'Invalid number of posts.',
        'wp_import_failed' => 'WordPress import failed.',
        'wp_import_done' => 'Imported: %d, skipped: %d, failed: %d.',
        'statuses' => [
            'draft' => 'Draft',
            'published' => 'Published',
        ],
