...
return [
    ...
    'media' => [
        ...
        'mass_title' => 'Bulk media upload',
        'mass_edit_title' => 'Bulk media edit',
        'mass_upload' => 'Bulk upload',
        'single_upload' => 'Single upload',
        'mass_info' => 'Upload multiple files at once. Name is generated from filename and can be edited in the table after upload.',
        'mass_edit_info' => 'Edit names and manage already uploaded media.',
        'mass_limit_hint' => 'Maximum 10 files per upload.',
        'mass_limit_error' => 'You can upload at most 10 files at once.',
        'mass_result' => 'Upload result',
        'mass_save_names' => 'Save names',
        'mass_uploaded' => 'Bulk upload completed.',
        'mass_names_updated' => 'Names saved.',
