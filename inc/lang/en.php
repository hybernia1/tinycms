...
return [
    ...
    'install' => [
        ...
        'requirements_required_label' => 'Required requirements',
        'requirements_recommended_label' => 'Recommended requirements',
        'requirements_blocking' => 'Server does not meet required installation requirements.',
        'requirement.php_version' => 'PHP version >= 8.1',
        ...
        'requirement.gd_imagecreatefromjpeg' => 'GD function: imagecreatefromjpeg',
        'requirement.gd_imagecreatefrompng' => 'GD function: imagecreatefrompng',
        'requirement.gd_imagecreatefromgif' => 'GD function: imagecreatefromgif',
        'requirement.gd_imagecreatefromwebp' => 'GD function: imagecreatefromwebp',
        'requirement.gd_imagewebp' => 'GD function: imagewebp',
        'requirement.fs_config_writable' => 'Writable config.php/root directory',
        'requirement.fs_uploads_writable' => 'Writable uploads/root directory',
        'requirement.intl_transliterator' => 'Intl Transliterator (recommended)',
        'requirement.ext_curl' => 'PHP extension: curl (recommended)',
