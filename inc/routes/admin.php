...
register_routes($router, $redirect, [
    ...
    ['method' => 'GET', 'path' => 'admin/api/v1/fetch', 'controller' => $adminContentMediaApi, 'action' => 'fetchApiV1'],
    ['method' => 'POST', 'path' => 'admin/api/v1/fetch', 'controller' => $adminContentMediaApi, 'action' => 'fetchApiV1'],
