...
register_routes($router, $redirect, [
    ...
    ['method' => 'GET', 'path' => 'admin/content', 'controller' => $adminContentList, 'action' => 'list'],
    ['method' => 'GET', 'path' => 'admin/api/v1/content', 'controller' => $adminContentList, 'action' => 'listApiV1'],
    ['method' => 'POST', 'path' => 'admin/api/v1/content/{id}/delete', 'controller' => $adminContentForm, 'action' => 'deleteApiV1', 'params' => ['id' => 'int']],
    ['method' => 'POST', 'path' => 'admin/api/v1/content/{id}/status', 'controller' => $adminContentWorkflowApi, 'action' => 'statusApiV1', 'params' => ['id' => 'int']],
    ['method' => 'POST', 'path' => 'admin/api/v1/content/draft/init', 'controller' => $adminContentWorkflowApi, 'action' => 'draftInitApiV1'],
    ['method' => 'POST', 'path' => 'admin/api/v1/content/autosave', 'controller' => $adminContentWorkflowApi, 'action' => 'autosaveApiV1'],
    ['method' => 'GET', 'path' => 'admin/api/v1/link-title', 'controller' => $adminContentWorkflowApi, 'action' => 'linkTitleApiV1'],
    ['method' => 'GET', 'path' => 'admin/content/add', 'controller' => $adminContentForm, 'action' => 'addForm'],
    ['method' => 'POST', 'path' => 'admin/content/add', 'controller' => $adminContentForm, 'action' => 'addSubmit'],
    ['method' => 'GET', 'path' => 'admin/content/edit', 'controller' => $adminContentForm, 'action' => 'editForm'],
    ['method' => 'POST', 'path' => 'admin/content/edit', 'controller' => $adminContentForm, 'action' => 'editSubmit'],
    ['method' => 'POST', 'path' => 'admin/content/edit/delete', 'controller' => $adminContentForm, 'action' => 'deleteSubmit'],
    ['method' => 'GET', 'path' => 'admin/api/v1/content/{contentId}/media', 'controller' => $adminContentLibraryApi, 'action' => 'mediaLibraryApiV1', 'params' => ['contentId' => 'int']],
    ['method' => 'POST', 'path' => 'admin/api/v1/content/{contentId}/media/upload', 'controller' => $adminContentLibraryApi, 'action' => 'mediaLibraryUploadApiV1', 'params' => ['contentId' => 'int']],
    ['method' => 'POST', 'path' => 'admin/api/v1/content/{contentId}/media/{mediaId}/delete', 'controller' => $adminContentLibraryApi, 'action' => 'mediaLibraryDeleteApiV1', 'params' => ['contentId' => 'int', 'mediaId' => 'int']],
    ['method' => 'POST', 'path' => 'admin/api/v1/content/{contentId}/media/{mediaId}/rename', 'controller' => $adminContentLibraryApi, 'action' => 'mediaLibraryRenameApiV1', 'params' => ['contentId' => 'int', 'mediaId' => 'int']],
    ['method' => 'POST', 'path' => 'admin/api/v1/content/{contentId}/media/{mediaId}/attach', 'controller' => $adminContentAttachmentApi, 'action' => 'attachmentAttachApiV1', 'params' => ['contentId' => 'int', 'mediaId' => 'int']],
    ['method' => 'POST', 'path' => 'admin/api/v1/content/{contentId}/thumbnail/detach', 'controller' => $adminContentThumbnailApi, 'action' => 'thumbnailDetachApiV1', 'params' => ['contentId' => 'int']],
    ['method' => 'POST', 'path' => 'admin/api/v1/content/{contentId}/thumbnail/{mediaId}/select', 'controller' => $adminContentThumbnailApi, 'action' => 'thumbnailSelectApiV1', 'params' => ['contentId' => 'int', 'mediaId' => 'int']],
