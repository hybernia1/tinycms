...
register_routes($router, $redirect, [
    ...
    ['method' => 'GET', 'path' => 'admin/api/v1/content/{id}/media', 'controller' => $adminContentMediaApi, 'action' => 'mediaLibraryApiV1', 'params' => ['id' => 'int']],
    ['method' => 'POST', 'path' => 'admin/api/v1/content/{id}/media/upload', 'controller' => $adminContentMediaApi, 'action' => 'mediaLibraryUploadApiV1', 'params' => ['id' => 'int']],
    ['method' => 'POST', 'path' => 'admin/api/v1/content/{id}/media/{mediaId}/delete', 'controller' => $adminContentMediaApi, 'action' => 'mediaLibraryDeleteApiV1', 'params' => ['id' => 'int', 'mediaId' => 'int']],
    ['method' => 'POST', 'path' => 'admin/api/v1/content/{id}/media/{mediaId}/rename', 'controller' => $adminContentMediaApi, 'action' => 'mediaLibraryRenameApiV1', 'params' => ['id' => 'int', 'mediaId' => 'int']],
    ['method' => 'POST', 'path' => 'admin/api/v1/content/{id}/media/{mediaId}/attach', 'controller' => $adminContentMediaApi, 'action' => 'attachmentAttachApiV1', 'params' => ['id' => 'int', 'mediaId' => 'int']],
    ['method' => 'POST', 'path' => 'admin/api/v1/content/{id}/thumbnail/detach', 'controller' => $adminContentMediaApi, 'action' => 'thumbnailDetachApiV1', 'params' => ['id' => 'int']],
    ['method' => 'POST', 'path' => 'admin/api/v1/content/{id}/thumbnail/{mediaId}/select', 'controller' => $adminContentMediaApi, 'action' => 'thumbnailSelectApiV1', 'params' => ['id' => 'int', 'mediaId' => 'int']],
