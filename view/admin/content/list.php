    ...
    <tr>
        ...
        <td class="table-col-actions">
            <?php if ($canManage): ?>
                ...
                <button class="btn btn-light btn-icon" type="button" data-content-delete-open="<?= $id ?>" data-modal-open data-modal-target="#content-delete-modal" aria-label="<?= htmlspecialchars($t('common.delete'), ENT_QUOTES, 'UTF-8') ?>" title="<?= htmlspecialchars($t('common.delete'), ENT_QUOTES, 'UTF-8') ?>">
                    <?= $icon('delete') ?>
