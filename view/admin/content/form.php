...
<?php endif; ?>
<?php require __DIR__ . '/../partials/modals/media-library.php'; ?>
<?php require __DIR__ . '/../partials/modals/content-leave.php'; ?>
<?php if ($mode === 'edit'): ?>
<?php
$modal = [
    'id' => 'content-delete-modal',
    'attributes' => ['data-modal' => null],
    'message' => $t('content.delete_confirm', 'Do you really want to delete this content?'),
    'message_attributes' => ['data-modal-text' => null],
    'confirm_attributes' => ['type' => 'button', 'data-modal-confirm' => null, 'data-form-id' => 'content-delete-form'],
];
require __DIR__ . '/../partials/modals/confirm.php';
?>
<?php endif; ?>
