    ...
    <tr>
        ...
        <td class="table-col-actions">
            <?php if (!$isAdmin): ?>
                ...
                <button class="btn btn-light btn-icon" type="button" data-users-delete-open="<?= $id ?>" data-modal-open data-modal-target="#users-delete-modal" aria-label="<?= htmlspecialchars($t('users.delete', 'Delete user'), ENT_QUOTES, 'UTF-8') ?>" title="<?= htmlspecialchars($t('users.delete', 'Delete user'), ENT_QUOTES, 'UTF-8') ?>">
                    <?= $icon('delete') ?>
