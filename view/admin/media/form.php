...
<?php if ($mode === 'edit'): ?>
    ...
    $modal = [
        ...
        'message' => $t('media.delete_confirm', 'Do you really want to delete this media?'),
        'message_attributes' => ['data-modal-text' => null],
        'confirm_attributes' => ['type' => 'button', 'data-modal-confirm' => null, 'data-form-id' => 'media-delete-form'],
    ];
